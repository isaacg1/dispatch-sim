                ...
                for rho in vec![0.8, 0.98] {
                    ...
                    */
                    if k == 100 {
                        ...
                        } else if let Size::Bimodal(_, _, _) = size {
                    ...
                    if k == 10 {
                        ...
                        if let Size::Exp(_) = size {
                            policies.push(Box::new(SITA::new(vec![
                                0.531812, 0.824388, 1.09735, 1.37642, 1.67835, 2.02231, 2.43922,
                                2.99431, 3.88972,
                            ])));
                        }
                        if let Size::Hyper(_, _, _) = size {
                            policies.push(Box::new(SITA::new(vec![
                                0.68331, 1.0975, 1.5237, 2.0227, 2.6933, 3.892, 532.771, 1376.997,
                                2439.687,
                            ])));
                        }
                    }
